...
f_price = wd.find_element_by_class_name("_1uv9Cb")
pr_name = wd.find_element_by_class_name("_9E25nV")
...
# wd.get(source3)
# wd.implicitly_wait(wait_imp)
# c_price = wd.find_element_by_id("title")
# raw_c = c_price.text
# # print (raw_c[1:7])
...
print("Price available at Flipkart is: "+r_price)
print("  Price available at Amazon is: "+raw_p)
